...
| **Vorlagen** | **28 fertige Seiten** mit eigenem Text (Willkommen, Ablauf, Pause, Laufschrift, Zitat, Ankündigung, Fragen, WLAN-QR, Countdown bis Uhrzeit, Geburtstag, Tabelle/Stundenplan, Abstimmung/Quiz, Arbeitsauftrag, Regeln, Gruppen, Stillarbeit, Danke, Hausaufgaben, Schlagzeile, Große Zahl, Termine, Türschild, Speiseplan, Siegerehrung, Stimmungsbarometer, Pro & Contra, Begriff, Gäste) und **23 fertige Szenen** – mit Kategorien und Suche. Sofort zeigen oder als Szene speichern; als Quelle „Gestaltete Seite“ auch in eigenen Szenen. Ablauf-Punkt weiterschalten per Kachel, Tastenkürzel oder Handy |
