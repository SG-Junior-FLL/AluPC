...
| **Vorlagen** | fertige **Seiten** mit eigenem Text – Willkommen, Ablauf/Agenda (Punkt weiterschalten per Kachel, Tastenkürzel, Handy), Pause mit Restzeit, Laufschrift, Zitat, Ankündigung, Fragen?, **WLAN-Zugang mit QR-Code** – und **fertige Szenen** (Begrüßung mit Uhr, Ablauf + Uhr, Pause, Kamera + Laufschrift, Fragerunde, Gäste-WLAN, Countdown bis Start). Sofort zeigen oder als Szene speichern; als Quelle „Gestaltete Seite“ auch in eigenen Szenen |
