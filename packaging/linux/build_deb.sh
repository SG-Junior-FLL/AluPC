...
Recommends: fprintd, libpam-fprintd, pkexec | policykit-1, wmctrl, pipewire, xdg-desktop-portal, uxplay, gstreamer1.0-plugins-good, gstreamer1.0-plugins-bad, gstreamer1.0-libav, avahi-daemon, x11-xserver-utils
