...
def _draw(name: str, p: QPainter, color: QColor):
    ...
    if name == "monitor":
        ...
        # breiter Textmarker mit schräger Spitze und Strich darunter
        path = QPainterPath(QPointF(9, 15))
        path.lineTo(16.5, 4.5)
        path.lineTo(20.5, 7.5)
        path.lineTo(13, 18)
        path.closeSubpath()
        p.drawPath(path)
        p.drawLine(QPointF(9, 15), QPointF(7, 18.5))
        p.drawLine(QPointF(13, 18), QPointF(10.5, 20))
        p.setBrush(fill)
        c = QColor(fill)
        c.setAlphaF(0.45)
        p.fillRect(QRectF(3, 20.5, 12, 2.5), c)
        p.setBrush(Qt.NoBrush)
    elif name == "eraser":
        path = QPainterPath(QPointF(3.5, 15))
        path.lineTo(13, 5.5)
        path.lineTo(20.5, 13)
        path.lineTo(13.5, 20)
        path.lineTo(8.5, 20)
        path.closeSubpath()
        p.drawPath(path)
        p.drawLine(QPointF(8.5, 10), QPointF(16, 17.5))
        p.drawLine(QPointF(8.5, 20), QPointF(21, 20))
    elif name == "undo":
        path = QPainterPath(QPointF(8, 14))
        path.lineTo(4, 10)
        path.lineTo(8, 6)
        p.drawPath(path)
        arc = QPainterPath(QPointF(4, 10))
        arc.lineTo(14, 10)
        arc.cubicTo(QPointF(21, 10), QPointF(21, 19), QPointF(14, 19))
        arc.lineTo(9, 19)
        p.drawPath(arc)
    elif name == "copy":
        ...
        p.drawRoundedRect(QRectF(13.7, 5, 3.8, 14), 1, 1)
        p.setBrush(Qt.NoBrush)
    elif name == "rewind":
        ...
        path = QPainterPath(QPointF(12.5, 6))
        path.lineTo(20, 12)
        path.lineTo(12.5, 18)
        path.closeSubpath()
        path.moveTo(4, 6)
        ...
        p.setBrush(fill)
        p.drawEllipse(QPointF(12, 7.6), 0.9, 0.9)
        p.setBrush(Qt.NoBrush)
    elif name == "alert":  # Warndreieck
        ...
        if name == "download":
            _arrow(p, 12, 3.5, 12, 14.5, head=4)
        else:
            _arrow(p, 12, 14.5, 12, 3.5, head=4)
        path = QPainterPath(QPointF(4, 15))
        path.lineTo(4, 19)
        path.quadTo(4, 20.5, 5.5, 20.5)
        path.lineTo(18.5, 20.5)
        path.quadTo(20, 20.5, 20, 19)
        path.lineTo(20, 15)
        p.drawPath(path)
    elif name == "sync":  # zwei Pfeile im Kreis
        p.drawArc(QRectF(4, 4, 16, 16), 20 * 16, 140 * 16)
        p.drawArc(QRectF(4, 4, 16, 16), 200 * 16, 140 * 16)
        path = QPainterPath(QPointF(16.8, 3.2))
        path.lineTo(19.6, 6.6)
        path.lineTo(15.4, 7.6)
        p.drawPath(path)
        path = QPainterPath(QPointF(7.2, 20.8))
        ...
        for angle in (0, 120, 240):
            ...
            p.translate(12, 12)
            p.rotate(angle)
            path = QPainterPath(QPointF(0, -2))
            path.cubicTo(QPointF(-1.5, -6), QPointF(1.5, -8.5), QPointF(4.5, -7.5))
            path.cubicTo(QPointF(4, -4.5), QPointF(2.5, -2.5), QPointF(1.7, -1))
            path.closeSubpath()
            p.setBrush(soft)
            p.drawPath(path)
            p.restore()
